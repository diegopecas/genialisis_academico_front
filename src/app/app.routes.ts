...
export const routes: Routes = [
  ...
  { path: 'administracion/entes-control', loadComponent: () => import('./components/administracion/entes-control/entes-control.component').then(m => m.EntesControlComponent), canActivate: [AuthGuard, PermisosGuard], data: { permiso: 'administracion.datos_maestros', trackear: true, labelAcceso: 'Entes de Control', iconoAcceso: '🏛️' } },
  { path: 'administracion/entes-control/:accion/:id', loadComponent: () => import('./components/administracion/entes-control/crear-ente-control/crear-ente-control.component').then(m => m.CrearEnteControlComponent), canActivate: [AuthGuard, PermisosGuard], data: { permiso: 'administracion.datos_maestros' } },
  { path: 'administracion/institucion', loadComponent: () => import('./components/administracion/institucion/institucion.component').then(m => m.InstitucionComponent), canActivate: [AuthGuard, PermisosGuard], data: { permiso: 'administracion.datos_maestros', trackear: true, labelAcceso: 'Institución', iconoAcceso: '🏫' } },
  ...
  { path: 'administracion/config-aseo', loadComponent: () => import('./components/administracion/config-aseo/config-aseo.component').then(m => m.ConfigAseoComponent), canActivate: [AuthGuard], data: { trackear: true, labelAcceso: 'Configuración de Aseo', iconoAcceso: '🧹' } },
  ...
  { path: 'operaciones/registro-masivo-limpieza', loadComponent: () => import('./components/operaciones/registros-limpieza/registro-masivo-limpieza/registro-masivo-limpieza.component').then(m => m.RegistroMasivoLimpiezaComponent), canActivate: [AuthGuard], data: { trackear: true, labelAcceso: 'Registro Masivo de Aseo', iconoAcceso: '📅' } },
  { path: 'operaciones/supervision-limpieza', loadComponent: () => import('./components/operaciones/registros-limpieza/supervision-limpieza/supervision-limpieza.component').then(m => m.SupervisionLimpiezaComponent), canActivate: [AuthGuard], data: { trackear: true, labelAcceso: 'Supervisión de Aseo', iconoAcceso: '✅' } },
  { path: 'operaciones/reporte-aseo', loadComponent: () => import('./components/operaciones/registros-limpieza/reporte-aseo/reporte-aseo.component').then(m => m.ReporteAseoComponent), canActivate: [AuthGuard], data: { trackear: true, labelAcceso: 'Reporte de Aseo', iconoAcceso: '📄' } },
