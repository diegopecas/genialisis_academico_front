...
export class PdeRangosEdadService {

  private servicio = environment.api + 'pde-rangos-edad';
  ...
  obtenerTodosList() {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + '/list', { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta && respuesta.error) {
  ...
  obtenerByEdad(edadMeses: any) {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + `/edad/${edadMeses}`, { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta && respuesta.error) {
