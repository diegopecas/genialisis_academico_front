...
export class UtilesDiariosGruposService {

  private servicio = environment.api + 'utiles-diarios-grupos';
  ...
  // Reemplaza de una vez todos los grupos de un elemento. Una lista vacia
