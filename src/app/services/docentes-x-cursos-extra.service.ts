...
export class DocentesXCursosExtraService {

  private servicio = environment.api + 'docentes-x-cursos-extra';
  ...
  private handleError(error: HttpErrorResponse): Observable<never> {
    console.error('Error en DocentesXCursosExtraService:', error);
