      ...
      },
      {
        ...
        grupos: [
          ...
          },
          {
            ...
            alt: 'Estudiantes',
            imagen: 'assets/images/estudiantes.png',
            permisos: ['estudiantes.observaciones.administrar', 'operaciones.actualizacion_datos', 'operaciones.autorizacion_informes', 'operaciones.evaluacion_desarrollo', 'operaciones.inscripcion_cursos_extra', 'operaciones.perfil_desarrollo', 'operaciones.recordatorios_generales', 'operaciones.seguimiento_asistencia'],
            keywords: ['alumnos', 'niños', 'ninos'],
            opciones: [
