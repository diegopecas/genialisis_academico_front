...
,
          ...
          },
          {
            ...
            hijos: [
              ...
              { id: 'administracion-fin-registro-cobros', label: 'Registro Cobros Rápido', icono: '🧾', ruta: '/administracion/financiero/registro-cobros-rapido', permiso: 'admin.registro_cobros_rapido', keywords: ['cobros', 'cuentas por cobrar', 'generar cuentas', 'facturar', 'masivo', 'pensiones', 'matriculas', 'cartera'] },
              { id: 'administracion-fin-anulacion-cobros', label: 'Anulación Masiva de Cobros', icono: '🚫', ruta: '/administracion/financiero/anulacion-masiva-cobros', permiso: 'admin.anulacion_masiva_cobros', keywords: ['anular', 'anulacion', 'anulación', 'borrar cobros', 'cancelar cuentas', 'cuentas por cobrar', 'masivo', 'corregir cobros', 'cartera'] },
              ...
              { id: 'administracion-fin-mora-configuracion', label: 'Registro Rápido de Mora', icono: '⏰', ruta: '/administracion/financiero/mora-configuracion', permiso: 'admin.mora_configuracion', keywords: ['mora', 'interes', 'interés', 'intereses', 'multa', 'recargo', 'sancion', 'sanción', 'penalidad', 'cartera vencida', 'tasa', 'atraso', 'retraso', 'moroso', 'registro rapido', 'masivo', 'productos'] },
              { id: 'administracion-fin-mora-exenciones', label: 'Registro Rápido de Exenciones', icono: '🛡️', ruta: '/administracion/financiero/mora-exenciones', permiso: 'admin.mora_exenciones', keywords: ['mora', 'interes', 'interés', 'intereses', 'multa', 'recargo', 'exencion', 'exención', 'exonerar', 'exoneracion', 'perdonar', 'condonar', 'no cobrar', 'acuerdo de pago', 'registro rapido', 'masivo', 'personas', 'estudiantes'] },
              { id: 'administracion-fin-mora-ejecuciones', label: 'Proceso de Mora', icono: '⚙️', ruta: '/administracion/financiero/mora-ejecuciones', permiso: 'admin.mora_ejecuciones', keywords: ['mora', 'interes', 'interés', 'intereses', 'multa', 'recargo', 'proceso', 'liquidacion', 'liquidación', 'cron', 'calculo', 'cálculo', 'ejecuciones', 'automatico'] }
            ]
          },
          {
          ...
          },
          {
            ...
            hijos: [
              ...
              { id: 'administracion-config-geofence', label: 'Configuración Geofence', icono: '📍', ruta: '/administracion/datos-maestros/configuracion-geofence', permiso: 'admin.configuracion_geofence', keywords: ['ubicacion', 'ubicación', 'zonas', 'gps', 'geofence', 'geocerca', 'mapa', 'poligono', 'polígono', 'dibujar zona', 'dibujar el jardin', 'perimetro', 'perímetro', 'linderos', 'area del jardin', 'área del jardín', 'zona de asistencia', 'marcacion', 'marcación', 'coordenadas', 'satelital', 'planta del jardin'] },
