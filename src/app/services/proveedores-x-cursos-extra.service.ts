...
export class ProveedoresXCursosExtraService {

  private servicio = environment.api + 'proveedores-x-cursos-extra';
  ...
  private handleError(error: HttpErrorResponse): Observable<never> {
    console.error('Error en ProveedoresXCursosExtraService:', error);
