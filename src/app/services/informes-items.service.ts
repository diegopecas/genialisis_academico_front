...
export class InformesItemsService {

  private servicio = environment.api + 'informes-items';
  ...
  obtenerBySeccion(id_seccion: any): Observable<HttpResponse<Object>> {
    return this.http
      .get<HttpResponse<Object>>(`${this.servicio}/seccion/${id_seccion}`, {
        observe: 'response',
      })
      .pipe(
        tap((response: HttpResponse<Object>) => {
