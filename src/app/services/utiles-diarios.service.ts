...
export class UtilesDiariosService {

  private servicio = environment.api + 'utiles-diarios';
  ...
  obtenerPorGrupo(idGrupo: any) {
    return this.http
      .get<HttpResponse<Object>>(environment.api + `utiles-diarios-grupo/${idGrupo}`, { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta.error) {
