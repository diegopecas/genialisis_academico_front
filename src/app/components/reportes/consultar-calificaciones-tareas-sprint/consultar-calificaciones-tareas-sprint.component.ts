...
@Component({
  ...
  styleUrl: './consultar-calificaciones-tareas-sprint.component.scss',
  standalone: true,
...
export class ConsultarCalificacionesTareasSprintComponent implements OnInit {
  ...
  obtenerEstudiante(id_estudiante: any) {
    this.estudiantesService.obtenerById(id_estudiante).subscribe((response:any) => {
      ...
      this.consultarCalificacionesTareasSprint(id_estudiante);
    })
  }

  consultarCalificacionesTareasSprint(id_estudiante: any) {
    console.log("consultarCalificacionesTareasSprint", id_estudiante)
    this.calificacionesService.consultarCalificacionesTareasSprintEstudiante(id_estudiante).subscribe((response: any) => {
      const body = response.body as any[];
      console.log("consumo servicio consultarCalificacionesTareasSprintEstudiante", body);
      this.datos = body;
